...
from core.model.column_name import CommentsColumns, Complexity, Difficulty, LikesColumns, \
    Scope, StepColumns, TopicColumns
from core.utils.df_utils  import merge_dfs, read_df, write_df
from core.utils.logging_utils import configure_logger
from core.utils.stats_utils import calculate_code_lines_count
...
def get_block_info(step_block: str) -> pd.Series:
    ...
    blocks_info = {
        StepColumns.LANGUAGE.value: block[StepColumns.OPTIONS.value][StepColumns.LANGUAGE.value],
        StepColumns.TEXT.value: block[StepColumns.TEXT.value],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--filter-with-header-footer', type=bool, default=False,
