...
from core.src.utils.df_utils import read_df, equal_df
from core.src.utils.subprocess_runner import run_in_subprocess
from preprocessing.src import MAIN_FOLDER
from preprocessing.tests import SUBMISSIONS_FILE, TEST_DATA_FOLDER
...
def test_correct_arguments():
    command = [
        ...
        TEST_DATA_FOLDER / SUBMISSIONS_FILE,
    ]
...
def test_output_with_correct_arguments():
    output_file = TEST_DATA_FOLDER / 'preprocessed_submissions.csv'
    command = [
        sys.executable,
        (MAIN_FOLDER.parent / 'preprocess_submissions.py'),
        TEST_DATA_FOLDER / SUBMISSIONS_FILE,
    ...
    expected_df = read_df(TEST_DATA_FOLDER / 'preprocessed_submissions_expected.csv')
