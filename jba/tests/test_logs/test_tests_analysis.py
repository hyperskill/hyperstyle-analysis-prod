...
COMMON_TESTS = [
    ...
    TestData(
        class_name='Test',
        method_name='some_some_ignored_parametrized_test(String)',
        test='A',
        duration='0.0001s',
        result=TestResult.FAILED,
        test_number=1,
...
FIND_TEST_RESULT_DATA = [
    ('Test', 'some_method_name()', None, [], None),
    ('Test', 'some_parametrized_method_name()', 42, [], None),
    (
        'Test',
        'some_nonexistent_method_name()',
        None,
        [
            TestData(
                class_name='Test',
                method_name='some_method_name()',
                test='some_method_name()',
                duration='0.0001s',
                result=TestResult.PASSED,
            ),
            TestData(
                class_name='Test',
                method_name='some_parametrized_method_name(String)',
                test='A',
                duration='0.0001s',
                result=TestResult.PASSED,
                test_number=1,
    ...
    (
        'Test',
        'some_parametrized_method_name(String)',
        1,
        [
            TestData(
                class_name='Test',
...
CONVERT_TESTS_TO_TIMELINE_DATA = [
    ...
    (
        ...
        [
            ('Test', 'some_method_name()', None, TestResult.PASSED, 1, 1),
            ('Test', 'some_method_name()', None, TestResult.FAILED, 2, 2),
    ...
    (
        [
            ...
            [
                ...
                TestData(
                    class_name='Test',
                    method_name='some_unexpected_test_name()',
                    test='some_unexpected_test_name()',
                    duration='0.0001s',
                    result=TestResult.FAILED,
                    error_class='some_error_class',
                    message='some error message',
        ...
        [
            ...
            ('Test', 'some_parametrized_test(String)', 3, TestResult.FAILED, 3, 3),
            ('Test', 'some_parametrized_test(String)', 3, TestResult.PASSED, 4, 4),
            ('Test', 'some_unexpected_test_name()', None, TestResult.FAILED, 2, 2),
            ('Test', 'some_unexpected_test_name()', None, TestResult.PASSED, 3, 3),
    ...
    (
        ...
        [
            ('Test', 'some_method_name()', None, TestResult.PASSED, 3, 3),
            ('Test', 'some_method_name()', None, TestResult.FAILED, 4, 4),
            ('Test', 'some_method_name()', None, TestResult.PASSED, 5, 5),
            ('Test', 'some_method_name()', None, TestResult.PASSED, 7, 7),
...
AGGREGATE_TESTS_TIMELINE_DATA = [
    ...
    (
        [
            ('Test', 'some_method_name_1()', None, TestResult.FAILED, 1, 2),
            ('Test', 'some_method_name_1()', None, TestResult.PASSED, 3, 4),
            ('Test', 'some_method_name_2()', None, TestResult.FAILED, 1, 4),
            ('Test', 'some_method_name_3()', None, TestResult.IGNORED, 2, 3),
        ],
        [
            ('Test', 'some_method_name_1()', None, TestResult.FAILED, 1, 2),
            ('Test', 'some_method_name_1()', None, TestResult.PASSED, 3, 4),
    ...
    (
        [
            ('Test', 'some_parametrized_method_name_1(String)', 1, TestResult.PASSED, 1, 3),
            ('Test', 'some_parametrized_method_name_1(String)', 2, TestResult.FAILED, 1, 1),
            ('Test', 'some_parametrized_method_name_1(String)', 2, TestResult.PASSED, 2, 3),
            ('Test', 'some_parametrized_method_name_1(String)', 3, TestResult.PASSED, 1, 2),
            ('Test', 'some_parametrized_method_name_1(String)', 3, TestResult.FAILED, 3, 3),
            ('Test', 'some_parametrized_method_name_2(String)', 1, TestResult.PASSED, 1, 3),
            ('Test', 'some_parametrized_method_name_2(String)', 2, TestResult.IGNORED, 1, 1),
            ('Test', 'some_parametrized_method_name_3(String)', 1, TestResult.PASSED, 1, 3),
            ('Test', 'some_parametrized_method_name_3(String)', 2, TestResult.PASSED, 1, 3),
            ('Test', 'some_parametrized_method_name_3(String)', 3, TestResult.PASSED, 1, 3),
        ],
        [
            ('Test', 'some_parametrized_method_name_1(String)', None, TestResult.FAILED, 1, 1),
            ('Test', 'some_parametrized_method_name_1(String)', None, TestResult.PASSED, 2, 2),
            ('Test', 'some_parametrized_method_name_1(String)', None, TestResult.FAILED, 3, 3),
    ...
    (
        [
            ('Test', 'some_method_name()', None, TestResult.FAILED, 2, 2),
            ('Test', 'some_method_name()', None, TestResult.PASSED, 3, 4),
            ('Test', 'some_parametrized_method_name(String)', 1, TestResult.PASSED, 2, 3),
            ('Test', 'some_parametrized_method_name(String)', 2, TestResult.PASSED, 2, 3),
            ('Test', 'some_parametrized_method_name(String)', 3, TestResult.FAILED, 2, 2),
            ('Test', 'some_parametrized_method_name(String)', 3, TestResult.PASSED, 3, 3),
        ],
        [
            ('Test', 'some_method_name()', None, TestResult.FAILED, 2, 2),
            ('Test', 'some_method_name()', None, TestResult.PASSED, 3, 4),
