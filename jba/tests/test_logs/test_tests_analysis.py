...
FIND_TEST_RESULT_DATA = [
    ('Test', 'some_method()', None, [], None),
    ('Test', 'some_parametrized_method()', 42, [], None),
    (
        'Test',
        ...
        [
            ...
            TestData(
                class_name='Test',
                method_name='some_parametrized_method(String)',
                test='A',
                duration='0.0001s',
                result=TestResult.PASSED,
                test_number=1,
    ...
    (
        'Test',
        'some_parametrized_method(String)',
        1,
        [
            TestData(
                class_name='Test',
...
CONVERT_TESTS_TO_TIMELINE_DATA = [
    ...
    (
        ...
        [
            ('Test', 'some_method()', None, TestResult.PASSED, 1, 1),
            ('Test', 'some_method()', None, TestResult.FAILED, 2, 2),
            ('Test', 'some_method()', None, TestResult.PASSED, 3, 4),
    ...
    (
        ...
        [
            ('Test', 'some_method()', None, TestResult.PASSED, 3, 3),
            ('Test', 'some_method()', None, TestResult.FAILED, 4, 4),
            ('Test', 'some_method()', None, TestResult.PASSED, 5, 5),
            ('Test', 'some_method()', None, TestResult.PASSED, 7, 7),
...
AGGREGATE_TESTS_TIMELINE_DATA = [
    ...
    (
        [
            ('Test', 'some_method_1()', None, TestResult.FAILED, 1, 2),
            ('Test', 'some_method_1()', None, TestResult.PASSED, 3, 4),
            ('Test', 'some_method_2()', None, TestResult.FAILED, 1, 4),
            ('Test', 'some_method_3()', None, TestResult.IGNORED, 2, 3),
        ],
        [
            ('Test', 'some_method_1()', None, TestResult.FAILED, 1, 2),
            ('Test', 'some_method_1()', None, TestResult.PASSED, 3, 4),
    ...
    (
        [
            ('Test', 'some_parametrized_method_1(String)', 1, TestResult.PASSED, 1, 3),
            ('Test', 'some_parametrized_method_1(String)', 2, TestResult.FAILED, 1, 1),
            ('Test', 'some_parametrized_method_1(String)', 2, TestResult.PASSED, 2, 3),
            ('Test', 'some_parametrized_method_1(String)', 3, TestResult.PASSED, 1, 2),
            ('Test', 'some_parametrized_method_1(String)', 3, TestResult.FAILED, 3, 3),
            ('Test', 'some_parametrized_method_2(String)', 1, TestResult.PASSED, 1, 3),
            ('Test', 'some_parametrized_method_2(String)', 2, TestResult.IGNORED, 1, 1),
            ('Test', 'some_parametrized_method_3(String)', 1, TestResult.PASSED, 1, 3),
            ('Test', 'some_parametrized_method_3(String)', 2, TestResult.PASSED, 1, 3),
            ('Test', 'some_parametrized_method_3(String)', 3, TestResult.PASSED, 1, 3),
        ],
        [
            ('Test', 'some_parametrized_method_1(String)', None, TestResult.FAILED, 1, 1),
            ('Test', 'some_parametrized_method_1(String)', None, TestResult.PASSED, 2, 2),
            ('Test', 'some_parametrized_method_1(String)', None, TestResult.FAILED, 3, 3),
            ('Test', 'some_parametrized_method_2(String)', None, TestResult.IGNORED, 1, 1),
            ('Test', 'some_parametrized_method_2(String)', None, TestResult.PASSED, 2, 3),
            ('Test', 'some_parametrized_method_3(String)', None, TestResult.PASSED, 1, 3),
        ],
    ),
    (
        [
    ...
    (
        [
            ('Test', 'some_method()', None, TestResult.FAILED, 2, 2),
            ('Test', 'some_method()', None, TestResult.PASSED, 3, 4),
            ('Test', 'some_parametrized_method(String)', 1, TestResult.PASSED, 2, 3),
            ('Test', 'some_parametrized_method(String)', 2, TestResult.PASSED, 2, 3),
            ('Test', 'some_parametrized_method(String)', 3, TestResult.FAILED, 2, 2),
            ('Test', 'some_parametrized_method(String)', 3, TestResult.PASSED, 3, 3),
        ],
        [
            ('Test', 'some_method()', None, TestResult.FAILED, 2, 2),
            ('Test', 'some_method()', None, TestResult.PASSED, 3, 4),
            ('Test', 'some_parametrized_method(String)', None, TestResult.FAILED, 2, 2),
            ('Test', 'some_parametrized_method(String)', None, TestResult.PASSED, 3, 3),
        ],
    ),
]
